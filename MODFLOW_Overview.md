...
Name File	- The "master file listing which packages and files the model should use. The name file references the other input files and defines the output files. 
The name file usually has the ".nam" file extension.
